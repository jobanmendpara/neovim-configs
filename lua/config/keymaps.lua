...
vim.keymap.set("n", "<F4>", "<CMD>Silicon<CR>", { desc = "Screenshot" })
vim.keymap.set("v", "<F4>", "<CMD>'<,'>Silicon<CR>", { desc = "Screenshot" })

vim.keymap.set("n", "<M-.>", cmd("cd %:p:h"), { desc = "Move to this directory"})

vim.keymap.set("n", "<M-f>", cmd('Pick files'), { desc = "Find Files" })
vim.keymap.set("n", "<M-l>", cmd('Pick visit_labels'), { desc = "Labeled Files" })
vim.keymap.set("n", "<M-p>", cmd('Pick visit_paths'), { desc = "Frecent Files" })
vim.keymap.set(
  "n",
  "<M-S-f>",
  function()
...
vim.keymap.set("n", '<leader>fo', cmd('Pick oldfiles'), { desc = 'Telescope Recent Files' })
...
vim.keymap.set('n', '<leader>,o', cmd('Pick vim_options'), { desc = 'Options' })
