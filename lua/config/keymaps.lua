...
vim.keymap.set('n', '<F12>', cmd('Telescope lsp_definitions'), { desc = 'Telescope Definitions'})
vim.keymap.set('n', '<F24>', cmd('Telescope lsp_references'), { desc = 'Telescope References'})
vim.keymap.set('n', '<F60>', vim.lsp.buf.hover, { desc = 'Hover'})
...
vim.keymap.set("n", '<leader>lo', cmd('SymbolsOutline'), { desc = 'Document Symbols'})
